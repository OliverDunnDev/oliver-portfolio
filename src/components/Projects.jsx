export default function Projects() {
  return (
    <section id="projects">
      ...
      <a href="https://plennock.github.io/Honours-Stage-Project/" target="_blank" rel="noopener noreferrer" className="project-card">
      ...
      <a href="https://oliverdunndev.github.io/movie-app/" target="_blank" rel="noopener noreferrer" className="project-card">
